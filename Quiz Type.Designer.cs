namespace Coursework
{
    partial class Quiz_Type
    {
        ...
        private void InitializeComponent()
        {
            ...
            pDisclaimer.Location = new Point(13, 464);
            pDisclaimer.Name = "pDisclaimer";
            pDisclaimer.Size = new Size(221, 88);
            pDisclaimer.TabIndex = 23;
            pDisclaimer.Text = "Wildcard quizzes are quizzes compiled from a large online trivia repository, all questions are virtually unpredictable.";
            // 
            // Quiz_Type
            // 
